        ...
        <div className="gap flex min-h-[80vh] justify-center items-center">
            <div className="w-1/2 gap-20 flex flex-col">
                ...
                <div className="flex gap-7">
                    ...
                    <Hero_button text="Download code" bgColor="bg-[#F0C417]" textColor="text-black" fontWieght="font-semibold" borderColor="border-b-1 border-b-[#FFFFFF]" href="https://libropen.com/en/projects/js-cmp"/>
                </div>
            </div>
            <HeroGraph />
        </div>
